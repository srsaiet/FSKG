...
foreach ($configs as $c) {
    ...
    if (!$pubkey || (string)$pubkey->children($ns)->AlgorithmId !== "msft:rm/algorithm/pkey/2005") continue;
...
<head>
  <meta charset="utf-8">
  <title>Generador de claves para Flight Simulator Deluxe</title>
  <style>
    body {
...
<body>
  <div class="container">
    <h1>Generador de claves para Flight Simulator Deluxe</h1>
    <form id="keyForm">
